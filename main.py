...
# Initialize vote submission state
...
# Helper to calculate max allowed value for a slider
...
# 🧮 Voting Interface (only show if not yet submitted)
...
# ✅ Show Results (whether submitted or not)
